interface FitnessDetailsProps {
  ...
  setWeightCapacity: (value: string) => void;
  ...
  wellnessType: string;
  setWellnessType: (value: string) => void;

  usageArea: string;
  setUsageArea: (value: string) => void;

  wellnessBenefits: string;
  setWellnessBenefits: (value: string) => void;

  powerSource: string;
  setPowerSource: (value: string) => void;

  batteryCapacity: string;
  setBatteryCapacity: (value: string) => void;

  heatFunction: string;
  setHeatFunction: (value: string) => void;

  massageType: string;
  setMassageType: (value: string) => void;

  scent: string;
  setScent: (value: string) => void;

  volumeSize: string;
  setVolumeSize: (value: string) => void;
...
export default function FitnessDetails({
  ...
  return (
    <div className="form-section">
      <h3>Fitness & Wellness Details</h3>
